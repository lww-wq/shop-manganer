<template>
	<div>
		<el-page-header @back="handleBack" content="修改卡类型信息"></el-page-header>
		<el-row>
			<el-col :span="24">
				<el-form 
					:model="addForm" 
					...
					<el-form-item size="mini" prop="bm" label="编码">
						<el-input placeholder="请输入" clearable v-model.trim="addForm.bm" ></el-input>
					</el-form-item>
...
<script>
	...
	export default{
		...
		methods:{
			...mapActions('cardTypeModel',['findById','update']),
			handleBack(){
