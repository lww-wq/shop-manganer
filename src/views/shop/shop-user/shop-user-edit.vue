<template>
	<div>
		<el-page-header @back="handleBack" content="编辑商城会员信息"></el-page-header>
		<el-row>
			<el-col :span="24">
				<el-form 
					:model="addForm" 
...
<script>
	...
	export default{
		...
		async created(){
			...
			this.addForm.birthday = `${d.getFullYear()}-${d.getMonth()+1}-${d.getDate()}`
		...
		methods:{
			...mapActions('shopUserModel',['findById','getUserTypeListAll','update']),
			handleBack(){
