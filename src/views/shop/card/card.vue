...
<div class="page">
    ...
    <el-table border size="mini" :data="list">
        ...
        <el-table-column label="会员卡logo">
            <template v-slot="{ row }">
                <el-image style="width: 100px; height: 100px; border-radius: 9px" fit="cover" :src="row.logo" :preview-src-list="[row.logo]">
                </el-image>
            </template>
        </el-table-column>
        ...
        <el-table-column width="300px" label="操作">
            <template v-slot="{ row }">
                <el-button v-if="row.status == 0" size="mini" icon="el-icon-edit" @click="handleOpenCard(row)" plain type="warning">开卡</el-button>
                <el-button v-else size="mini" icon="el-icon-edit" @click="handleOpenCard(row)" plain type="danger">退卡</el-button>
